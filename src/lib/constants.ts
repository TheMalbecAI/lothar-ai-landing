...
export const PROBLEM_CONTENT = {
  label: "THE PROBLEM",
  heading: "Traditional Ad Creation Is Bleeding Your Budget",
  cards: [
    {
      stat: "$500 to $2,000+",
      title: "Per Ad Set",
      description:
        "Multiply that by every product, every angle, every campaign. The costs compound fast, and you still don't know which ads will convert.",
    },
    {
      stat: "2 to 4 Weeks",
      title: "Average Turnaround",
      description:
        "Concept, draft, revisions, final delivery. By the time your ads are ready, the market moment has already passed.",
    },
    {
      stat: "1 in 6",
      title: "Ads Actually Convert",
      description:
        "Most ads fail because they rely on creative intuition instead of proven psychological frameworks. You're paying to guess.",
    },
  ],
};
...
export const FEATURES = [
  ...
  },
  {
    ...
    description:
      "Describe any scene you can imagine. Your product in space, on a mountain, in a lab. You have complete creative freedom to craft any ad concept. Nothing is locked or templated.",
    icon: "prompts",
  },
  {
